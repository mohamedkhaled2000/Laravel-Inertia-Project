              ...
              <div class="col-12">
                ...
                <div v-if="$page.props.flash.error" class="alert alert-danger alert-dismissible">
                  ...
                  <div class="card-header">
                    <!-- <Link :href="route('class.add')" class="btn btn-success">اضافة صف</Link> -->
                ...
                <button type="button" @click="delete_all(checkname)" class="btn btn-danger">حذف المحدد</button>
                <div class="card">
                  <!-- /.card-header -->
                  <div class="card-body">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr v-for="(classRom, i) in classes">
                          <td><input type="checkbox" :value="classRom.id" v-model="checkname"/></td>
                          <td>{{++i}}</td>
                          <td>{{ classRom.class_name }}</td>
                          <td>{{ classRom.grade.name }}</td>
                          <td class="text-right py-0 align-middle">
                                <div class="btn-group btn-group-sm">
                                    <Link :href="route('class.edit',classRom.id)" class="btn btn-info"><i class="fas fa-edit"></i></Link>
                                    <button type="submit" @click="destory(classRom.id)" class="btn btn-danger"><i class="fas fa-trash"></i></button>
                                </div>
                            </td>
                        </tr>
      ...
      <!-- /.content-wrapper -->
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-body">
                <form role="form" @submit.prevent="form.post(route('class.store'))">

                    <div class="form-group">
                        <label for="exampleInputEmail1">اسم الصف</label>
                        <input v-model="form.class_name" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                        <div v-if="form.errors.class_name" v-text="form.errors.class_name" class="text-danger"></div>
