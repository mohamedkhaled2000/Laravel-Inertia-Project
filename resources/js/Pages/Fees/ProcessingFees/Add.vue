                ...
                <div class="container-fluid">
                    <div class="row page-titles mx-0">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ student.name }} استبعاد رسوم</li>
                ...
                <div class="row">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3>{{ student.name }} استبعاد رسوم</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
...
export default {
    ...
    setup(props){
        ...
        let submit = () => {
            form.post(route('processing_fees.store'), {
                preserveScroll: true,
