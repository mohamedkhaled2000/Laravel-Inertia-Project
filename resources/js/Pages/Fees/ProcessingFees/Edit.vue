                ...
                <div class="container-fluid">
                    <div class="row page-titles mx-0">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ processing.student.name }} معالجة رسوم</li>
                ...
                <div class="row">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3>{{ processing.student.name }} معالجة رسوم</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
...
export default {
    ...
    setup(props){
        ...
        let form = useForm({
            student_id : props.processing.student_id,
            amount : props.processing.amount,
            notes : props.processing.notes,
        });

        let submit = () => {
            form.put(route('processing_fees.update',props.processing.id), {
                preserveScroll: true,
            })
        }
