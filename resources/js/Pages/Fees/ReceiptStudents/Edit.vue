                ...
                <div class="container-fluid">
                    <div class="row page-titles mx-0">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ receipt.student.name }} سند قبض</li>
                ...
                <div class="row">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3>{{ receipt.student.name }} سند قبض</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
...
export default {
    ...
    setup(props){
        ...
        let form = useForm({
            student_id : props.receipt.student_id,
            amount : props.receipt.debit,
            notes : props.receipt.notes,
        });

        let submit = () => {
            form.put(route('receipt.update',props.receipt.id), {
                preserveScroll: true,
