                ...
                <div class="col-12">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <tbody>
                                <tr v-for="(receipt, i) in receipts">
                                <td>{{++i}}</td>
                                ...
                                <td class="text-right py-0 align-middle">
                                        <div class="btn-group btn-group-sm">
                                            <Link :href="route('receipt.edit',receipt.id)" class="btn btn-info"><i class="fa fa-edit"></i></Link>
                                            <button type="submit" @click="destory(receipt.id)" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                                        </div>
                                    </td>
                                </tr>
            ...
            const destory = (id) => {
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        Inertia.delete(route('receipt.destroy',id),{
                            onSuccess: () => {
                                swal("تم الحذف بنجاح", {
                                    icon: "success",
                                });
