            ...
            <div class="content-body">
                <div class="container-fluid">
                    <div class="row page-titles mx-0">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">تعديل رسم جديد</li>
                ...
                <div class="row">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" @submit.prevent="form.put(route('fees.update',fee.id))">
                            <div class="card-body">
                                <div class="row">
...
export default {
    ...
    setup(props){
        ...
        let form = useForm({
            ...
            grade_id :props.fee.grade_id,
            class_room_id :props.fee.class_room_id,
