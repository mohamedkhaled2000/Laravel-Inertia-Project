...
export default {
    ...
    mounted(){
        this.classessRom = this.data.class_room_id.filter((el) => el.grade_id == this.student.grade_id)
        this.sections = this.data.section_id.filter((el) => el.class_room_id == this.student.class_room_id)
    },
    setup(props){
