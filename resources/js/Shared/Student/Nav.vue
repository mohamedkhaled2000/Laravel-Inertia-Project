                    ...
                    <ul class="navbar-nav header-right">
                        <li class="nav-item dropdown notification_dropdown">
                            <a class="nav-link bell ai-icon" data-toggle="dropdown" href="#" role="button">
                                <svg class="feather feather-bell" fill="none" height="20" id="icon-user"
                        ...
                        <li class="nav-item dropdown header-profile">
                            ...
                            <div class="dropdown-menu dropdown-menu-left">
                                <Link :href="route('student.profile')" class="dropdown-item ai-icon">
                                    <svg class="feather feather-user" fill="none" height="18" id="icon-user1"
                                         stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <a class="dropdown-item ai-icon" href="./email-inbox.html">
                                    <svg class="feather feather-mail" fill="none" height="18" id="icon-inbox"
                                         stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                         stroke-width="2" viewbox="0 0 24 24" width="18"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <Link class="dropdown-item ai-icon"
                                      :href="route('logoutStudent')">
                                    <svg class="feather feather-log-out" fill="none" height="18" id="icon-logout"
                                         stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                         stroke-width="2" viewbox="0 0 24 24" width="18"
                                         xmlns="http://www.w3.org/2000/svg">
