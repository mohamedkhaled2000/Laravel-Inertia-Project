            ...
            a.each(c, function (a, c) {
              ...
              if (b.which === c.which) {
                var e = !c.hasOwnProperty("altKey") || b.altKey === c.altKey,
                  f =
                    !c.hasOwnProperty("shiftKey") || b.shiftKey === c.shiftKey,
                  ...
                  if (
                    ...
                    if ((f.$element.trigger(o), !o.cancel)) {
                      ...
                      c || f.pushVal(f.options.triggerChange),
                        ...
                        a(".typeahead, .twitter-typeahead", f.$container)
            ...
            e.$container.on(
              ...
              e.options.addOnBlur &&
                ...
                e.$input.on(
                  ...
                  a.proxy(function (b) {
                    0 ===
                      a(".typeahead, .twitter-typeahead", e.$container)
                        .length && (e.add(e.$input.val()), e.$input.val(""));
                  }, e)
                ),
              e.$container.on({
                focusin: function () {
